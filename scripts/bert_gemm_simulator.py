...
GEMMs = [
    ...
    [("gemm", "f32_r", "N", "N", hidden_size, total_token_count, intermediate_size, 1, hidden_size, intermediate_size, 0, hidden_size),
     ...
     ("gemm", "f32_r", "T", "N",  hidden_size, total_token_count, intermediate_size, 1, intermediate_size, intermediate_size, 0, hidden_size)],
    [
    ...
    [("gemm", "f32_r", "N", "T", hidden_size, vocab_size, batch_prediction_length, 1, hidden_size, vocab_size, 0, hidden_size),
     ("gemm", "f32_r", "N", "N", hidden_size, batch_prediction_length,
      vocab_size, 1, hidden_size, vocab_size, 0, hidden_size),
     ("gemm", "f32_r", "T", "N", vocab_size, batch_prediction_length, hidden_size, 1, hidden_size, hidden_size, 0, vocab_size)],
    [("gemm", "f32_r", "N", "T", hidden_size, 2, batch_size, 1, hidden_size, 2, 0, hidden_size),
     ("gemm", "f32_r", "N", "N", hidden_size,
      batch_size, 2, 1, hidden_size, 2, 0, hidden_size),
     ("gemm", "f32_r", "T", "N", 2, batch_size, hidden_size, 1, hidden_size, hidden_size, 0, 2)]
